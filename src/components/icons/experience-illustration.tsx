...
function ExperiencePageSVG() {
  return (
    <>
      ...
      >
        <title>Career Growth Process💯</title>
        <rect
          x="155"
          y="304.52"
          width="130.73"
        ...
        <rect
          ...
          opacity="0.1"
        ></rect>
        <ellipse cx="547" cy="660.5" rx="547" ry="99.5" fill="#313638" opacity="0.1"></ellipse>
        <polygon
          points="240 321 194 603 402 581 393 557 230.5 570.5 268.5 320.5 240 321"
          fill="#313638"
        ></polygon>
        <polygon points="186 1 466 0 547 613 266 651 186 1" fill="#313638"></polygon>
        <polygon
...
export default ExperiencePageSVG;
