  ...
  return (
    <>
      <svg
        ...
        width="40px"
        height="40px"
        viewBox="39.97 26.75 208.06 234.5"
      >
        <path
          d="m227.82 69.69v191.56h-167.64v-234.5h131.48z"
          fill="#e0e0e0"
          stroke="currentColor"
          strokeMiterlimit="10"
          strokeWidth="10"
        />
        <path
          d="m39.97 129.78h208.06v92.3h-208.06z"
          fill="#ffe083"
          stroke="currentColor"
          strokeMiterlimit="10"
          strokeWidth="10"
        ...
        <path
          d="m186.66 30s-10 54.39 37.67 43.66"
          fill="none"
          stroke="currentColor"
          strokeMiterlimit="10"
          strokeWidth="10"
...
export const TailwindSVG = () => {
  return (
    <>
      <svg xmlns="http://www.w3.org/2000/svg" width="40px" height="40px" viewBox="0 0 256 256">
        <g fill="none">
          <rect width="40px" height="40px" fill="#242938" rx="60" />
          <path
...
export const JwtSVG = () => {
  return (
    <>
      <svg xmlns="http://www.w3.org/2000/svg" width="40px" height="40px" viewBox="0 0 512 172">
        <path
          fill="#FFF"
          d="M98.192 46.017L98.021 0h-25.66l.171 46.017l12.83 17.619zm-25.66 78.861v46.188h25.66v-46.188l-12.83-17.62z"
        />
        <path
          fill="#00F2E6"
          d="m98.192 124.878l27.028 37.292l20.699-15.053l-27.028-37.293l-20.699-6.671zm-25.66-78.861l-27.2-37.293l-20.699 15.054L51.662 61.07l20.87 6.672z"
        />
        <path
          fill="#00B9F1"
          d="M51.662 61.07L7.869 46.872L0 71.163l43.793 14.37l20.699-6.843zm54.399 31.134l12.83 17.62l43.793 14.199l7.869-24.292l-43.793-14.198z"
        />
        <path
          fill="#D63AFF"
          d="m126.76 85.533l43.793-14.37l-7.869-24.291l-43.793 14.198l-12.83 17.62zm-82.967 0L0 99.731l7.869 24.292l43.793-14.199l12.83-17.62z"
        />
        <path
          fill="#FB015B"
          d="m51.662 109.824l-27.029 37.293l20.699 15.053l27.2-37.292v-21.725zm67.229-48.754l27.028-37.292L125.22 8.724L98.192 46.017v21.725z"
        />
...
export const ReduxSVG = () => {
  return (
    <>
      <svg xmlns="http://www.w3.org/2000/svg" width="40px" height="40px" viewBox="0 0 256 244">
        <path
          fill="#764ABC"
...
export const ExpressJsSVG = () => {
  return (
    <>
      <svg xmlns="http://www.w3.org/2000/svg" width="40px" height="40px" viewBox="0 0 512 149">
        <path
          fill="currentColor"
  ...
  return (
    <>
      <svg xmlns="http://www.w3.org/2000/svg" width="40px" height="40px" viewBox="0 0 256 256">
        <path
          fill="#FF6C37"
          d="M254.953 144.253c8.959-70.131-40.569-134.248-110.572-143.206C74.378-7.912 10.005 41.616 1.047 111.619c-8.959 70.003 40.569 134.248 110.572 143.334c70.131 8.959 134.248-40.569 143.334-110.7Z"
        />
        <path
          fill="#FFF"
          d="m174.2 82.184l-54.007 54.007l-15.23-15.23c53.111-53.11 58.358-48.503 69.236-38.777Z"
        />
        <path
          fill="#FF6C37"
          d="M120.193 137.47c-.384 0-.64-.128-.896-.384l-15.357-15.229a1.237 1.237 0 0 1 0-1.791c54.006-54.007 59.637-48.888 71.027-38.65c.256.256.384.512.384.896s-.128.64-.384.896l-54.006 53.878c-.128.256-.512.384-.768.384Zm-13.437-16.509l13.437 13.438l52.087-52.087c-9.47-8.446-15.87-11.006-65.524 38.65Z"
        />
        <path
          fill="#FFF"
          d="m135.678 151.676l-14.717-14.718l54.006-54.006c14.462 14.59-7.166 38.265-39.289 68.724Z"
        />
        <path
          fill="#FF6C37"
          d="M135.678 152.956c-.384 0-.64-.128-.895-.384l-14.718-14.718c-.256-.256-.256-.512-.256-.896c0-.383.128-.64.384-.895L174.2 82.056a1.237 1.237 0 0 1 1.792 0a15.58 15.58 0 0 1 4.991 11.902c-.256 14.206-16.38 32.25-44.28 58.614c-.384.256-.768.384-1.024.384Zm-12.925-15.998c8.19 8.319 11.646 11.646 12.925 12.926c21.5-20.476 42.36-41.464 42.489-55.926c.128-3.327-1.152-6.655-3.328-9.214l-52.086 52.214Z"
        />
        <path
          fill="#FFF"
          d="m105.22 121.345l10.878 10.878c.256.256.256.512 0 .768c-.128.128-.128.128-.256.128l-22.524 4.863c-1.152.128-2.176-.64-2.432-1.791c-.128-.64.128-1.28.512-1.664l13.054-13.054c.256-.256.64-.384.768-.128Z"
        />
        <path
          fill="#FF6C37"
          d="M92.934 139.262c-1.92 0-3.327-1.536-3.327-3.455c0-.896.384-1.792 1.024-2.432l13.053-13.054c.768-.64 1.792-.64 2.56 0l10.878 10.878c.768.64.768 1.792 0 2.56c-.256.256-.512.384-.896.512l-22.524 4.863c-.256 0-.512.128-.768.128Zm11.902-16.509l-12.542 12.542c-.256.256-.384.64-.128 1.024c.128.384.512.511.896.384l21.116-4.608l-9.342-9.342Z"
        />
        <path
          fill="#FFF"
          d="M202.738 52.238c-8.19-7.935-21.372-7.679-29.306.64c-7.935 8.318-7.679 21.372.64 29.306A20.678 20.678 0 0 0 199.154 85l-14.59-14.59l18.173-18.172Z"
        />
        <path
          fill="#FF6C37"
          d="M188.405 89.223c-12.158 0-22.012-9.854-22.012-22.012c0-12.158 9.854-22.012 22.012-22.012c5.63 0 11.134 2.176 15.23 6.143c.255.256.383.512.383.896s-.128.64-.384.896L186.357 70.41l13.566 13.566c.512.512.512 1.28 0 1.792l-.256.256c-3.328 2.047-7.295 3.2-11.262 3.2Zm0-41.336c-10.75 0-19.453 8.702-19.325 19.452c0 10.75 8.703 19.453 19.453 19.325c2.943 0 5.887-.64 8.574-2.048l-13.437-13.31c-.256-.256-.384-.512-.384-.896c0-.383.128-.64.384-.895l17.149-17.15c-3.456-2.943-7.807-4.478-12.414-4.478Z"
        />
        <path
          fill="#FFF"
          d="m203.122 52.622l-.256-.256l-18.3 18.044l14.461 14.462c1.408-.896 2.815-1.92 3.967-3.072a20.51 20.51 0 0 0 .128-29.178Z"
        />
        <path
          fill="#FF6C37"
        ...
        <path
          fill="#FFF"
          d="M176.375 84.488a7.879 7.879 0 0 0-11.134 0l-48.247 48.247l8.062 8.063l51.063-44.792c3.328-2.816 3.583-7.807.768-11.134c-.256-.128-.384-.256-.512-.384Z"
        />
        <path
          fill="#FF6C37"
...
export const FigmaSVG = () => {
  return (
    <>
      <svg xmlns="http://www.w3.org/2000/svg" width="40px" height="40px" viewBox="0 0 256 384">
        <path
          fill="#0ACF83"
...
export const AzureSVG = () => (
  <svg xmlns="http://www.w3.org/2000/svg" width="40px" height="40px" viewBox="0 0 120 60">
...
export const PostgreSQLSVG = () => (
  <svg xmlns="http://www.w3.org/2000/svg" height="40" viewBox="0 0 25.6 25.6" width="64">
...
export const GCPSVG = () => (
  <svg xmlns="http://www.w3.org/2000/svg" width="40px" height="40px" viewBox="0 0 64 64">
    <path
